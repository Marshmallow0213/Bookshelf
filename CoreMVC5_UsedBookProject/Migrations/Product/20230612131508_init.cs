    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "P001", "作者", "Context1", "U001", new DateTime(2023, 6, 12, 21, 15, 7, 641, DateTimeKind.Local).AddTicks(5327), "二手", new DateTime(2023, 6, 12, 21, 15, 7, 643, DateTimeKind.Local).AddTicks(9568), "9876543210", "example.jpg", "無圖片,無圖片,無圖片,無圖片,無圖片,無圖片,無圖片,無圖片", "2023-01-01", "出版社", "未上架", "Book1", "金錢", 500m });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "Author", "ContentText", "CreateBy", "CreateDate", "Degree", "EditDate", "ISBN", "Image1", "Image2", "PublicationDate", "Publisher", "Status", "Title", "Trade", "UnitPrice" },
                values: new object[] { "P002", "作者", "Context2", "U001", new DateTime(2023, 6, 12, 21, 15, 7, 644, DateTimeKind.Local).AddTicks(247), "二手", new DateTime(2023, 6, 12, 21, 15, 7, 644, DateTimeKind.Local).AddTicks(252), "9876543211", "example.jpg", "無圖片,無圖片,無圖片,無圖片,無圖片,無圖片,無圖片,無圖片", "2023-01-01", "出版社", "未上架", "Book2", "金錢", 500m });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "Author", "ContentText", "CreateBy", "CreateDate", "Degree", "EditDate", "ISBN", "Image1", "Image2", "PublicationDate", "Publisher", "Status", "Title", "Trade", "UnitPrice" },
                values: new object[] { "P003", "作者", "Context3", "U001", new DateTime(2023, 6, 12, 21, 15, 7, 644, DateTimeKind.Local).AddTicks(259), "二手", new DateTime(2023, 6, 12, 21, 15, 7, 644, DateTimeKind.Local).AddTicks(260), "9876543212", "example.jpg", "無圖片,無圖片,無圖片,無圖片,無圖片,無圖片,無圖片,無圖片", "2023-01-01", "出版社", "未上架", "Book3", "以物易物", -1m });

            migrationBuilder.InsertData(
                table: "OrderByBarters",
                columns: new[] { "OrderByBarterId", "BuyerId", "CreateDate", "DenyReason", "ProductId", "SellerId", "Status" },
                values: new object[] { "OB001", "U003", new DateTime(2023, 6, 12, 21, 15, 7, 645, DateTimeKind.Local).AddTicks(4056), "none", "P003", "U001", "待確認" });

            migrationBuilder.InsertData(
                table: "OrderByMoneys",
                columns: new[] { "OrderByMoneyId", "BuyerId", "CreateDate", "DenyReason", "ProductId", "SellerId", "Status", "UnitPrice" },
                values: new object[] { "OM002", "U002", new DateTime(2023, 6, 12, 21, 15, 7, 645, DateTimeKind.Local).AddTicks(2288), "none", "P002", "U001", "待確認", 500m });

            migrationBuilder.InsertData(
                table: "OrderByMoneys",
                columns: new[] { "OrderByMoneyId", "BuyerId", "CreateDate", "DenyReason", "ProductId", "SellerId", "Status", "UnitPrice" },
                values: new object[] { "OM001", "U002", new DateTime(2023, 6, 12, 21, 15, 7, 645, DateTimeKind.Local).AddTicks(2012), "none", "P001", "U001", "待確認", 500m });
